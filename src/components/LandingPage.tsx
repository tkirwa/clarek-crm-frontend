...
const LandingPage: React.FC = () => {
    ...
    return (
        <>
            <section
                className="relative bg-[url(https://images.unsplash.com/photo-1531482615713-2afd69097998?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80)] bg-cover bg-center bg-no-repeat"
            >
                <div
                ...
                >
                    <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                        <h1 className="text-3xl font-extrabold sm:text-5xl">
                            ...
                            <strong className="block font-extrabold text-rose-700"> A Solution to Manage Customers </strong>
                        </h1>
